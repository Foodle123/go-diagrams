...
func main() {
	d, err := diagram.New(diagram.Filename("010_crefo_transmit_etl"), diagram.Label("crefo"), diagram.Direction("TB"))
	if err != nil {
		log.Fatal(err)
	}
	...
	EXP_KNEIFF_RTL_DE_SRS := azure.Database.SqlDatabases().Label("EXP_KNEIFF_RTL_DE_SRS")
	EXP_GSTSLF_RTL_DE_SRS := azure.Database.SqlDatabases().Label("EXP_GSTSLF_RTL_DE_SRS")
	EXP_KNEIFF_DLP_DE_SRS := azure.Database.SqlDatabases().Label("EXP_KNEIFF_DLP_DE_SRS")
	EXP_GSTSLF_DLP_DE_SRS := azure.Database.SqlDatabases().Label("EXP_GSTSLF_DLP_DE_SRS")
