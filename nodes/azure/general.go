...
func (c *generalContainer) XMLFile(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("assets/azure/general/xmlfile.png")}, c.opts, opts)
	return diagram.NewNode(nopts...)
}
...
func (c *generalContainer) DeutscheBundesbankLogo(opts ...diagram.NodeOption) *diagram.Node {
